...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Tue Sep 20 10:53:25 2016
# Project:  ts_wakeup.pro
# Template: app
# Command: /usr/local/QtEmbedded-4.7.2-arm/bin/qmake -spec /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++ CONFIG+=debug -o Makefile ts_wakeup.pro
#############################################################################
...
Makefile: ts_wakeup.pro  /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++/qmake.conf /usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++ CONFIG+=debug -o Makefile ts_wakeup.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ts_wakeup1.0.0/ && $(COPY_FILE) --parents stream.h detectobject.h .tmp/ts_wakeup1.0.0/ && $(COPY_FILE) --parents main.cpp stream.cpp detectobject.cpp .tmp/ts_wakeup1.0.0/ && (cd `dirname .tmp/ts_wakeup1.0.0` && $(TAR) ts_wakeup1.0.0.tar ts_wakeup1.0.0 && $(COMPRESS) ts_wakeup1.0.0.tar) && $(MOVE) `dirname .tmp/ts_wakeup1.0.0`/ts_wakeup1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ts_wakeup1.0.0
